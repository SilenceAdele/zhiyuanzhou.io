...
export const FooterInfo = {
  topMessage: [
    ...
    <a target="_blank" href="https://github.com/" title="本站部署服务使用 github"><img alt="github" src="https://img.shields.io/static/v1?label=Server&message=%7C%20GitHub&color=FF6A00&logo=github"></a>
    
    <a target="_blank" href="https://www.busuanzi.cc/" title="本站统计服务使用 busuanzi"><img alt="busuanzi" src="https://img.shields.io/badge/Count-busuanzi-FF6A00?logo=busuanzi"></a>`,
  ],
  theme: {
