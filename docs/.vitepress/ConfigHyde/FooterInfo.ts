...
export const FooterInfo = {
  topMessage: [
    ...
    <a target="_blank" href="https://github.com/" title="本站部署服务使用 github"><img alt="github" src="https://img.shields.io/static/v1?label=Server&message=GitHub&color=FF6A00&logo=github"></a>
