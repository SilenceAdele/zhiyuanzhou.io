...
// 布蒜子统计分析
  ...
  riskLink: {
    ...
    whitelist: ["https://github.com/SilenceAdele", "https://silenceadele.github.io/zhiyuanzhou.io/", "https://vp.teek.top/", "http://notes.teek.top","https://onedayxyy.cn/", /https:\/\/github.com/, /https:\/\/giee.com/], // 白名单，匹配到的链接不提示风险
...
export default defineConfig({
  ...
  sitemap: {
    hostname: "https://silenceadele.github.io/zhiyuanzhou.io",
  ...
  themeConfig: {
    ...
    search: {
      ...
      options: {
        appId: 'GY7Z9JS55H',
        apiKey: 'ec35eaa7fd5b2d41dac2f1d602e908a0',
        indexName: 'zhiyuanzhou-blog',
        locales: {
          root: {
            placeholder: '搜索文档',
            translations: {
      ...
      AutoFrontmatter({
          ...
          transform: (frontMatter: Record<string, any>, fileInfo: FileInfo) => {
              ...
              const rules: TransformRule[] = [
                  ...
                  { folderName: "04.操作系统", prefix: "/operating-system/$uuid5", removeLevel: 99}, // 清空前缀并且添加前缀使用随机数
                  { folderName: "05.计算机网络", prefix: "/computer-network/$uuid5", removeLevel: 99}, // 清空前缀并且添加前缀使用随机数
                  { folderName: "06.计算机编程", prefix: "/coding/$uuid5", removeLevel: 99}, // 清空前缀并且添加前缀使用随机数
                  { folderName: "07.故障排查", prefix: "/troubleshooting/$uuid5", removeLevel: 99}, // 清空前缀并且添加前缀使用随机数
                  { folderName: "08.折腾日记", prefix: "/toss-note/$uuid5", removeLevel: 99}, // 清空前缀并且添加前缀使用随机数
                  { folderName: "09.分享", prefix: "/share/$uuid5", removeLevel: 99}, // 清空前缀并且添加前缀使用随机数
                  { folderName: "10.心情", prefix: "/mood/$uuid5", removeLevel: 99}, // 清空前缀并且添加前缀使用随机数
                  { folderName: "11.关于我", prefix: "/about/$uuid5", removeLevel: 99}, // 清空前缀并且添加前缀使用随机数
              ];
              // 应用规则转换
